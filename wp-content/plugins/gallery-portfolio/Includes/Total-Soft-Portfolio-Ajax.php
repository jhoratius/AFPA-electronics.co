<?php 
	...
	function TotalSoftPortfolio_Edit_Callback()
	{
		...
		print json_encode($Total_Soft_PortfolioManager);
		die();
	}
	...
	function TotalSoftPortfolio_Edit_Album_Callback()
	{
		...
		print json_encode($Total_Soft_PortfolioAlbums);
		die();
	}
	...
	function TotalSoftPortfolio_Edit_Images_Callback()
	{
		...
		print json_encode($Total_Soft_PortfolioImages);
		die();
	}
	...
	function TotalSoftPortfolioOpt_Edit_Callback()
	{
		...
		print json_encode($Total_Soft_PortfolioSet);
		die();
	}
	...
	add_action( 'wp_ajax_nopriv_TS_PTable_New_MTable_DisMiss_Port', 'TS_PTable_New_MTable_DisMiss_Callback_Port' );
	...
	add_action( 'wp_ajax_nopriv_TS_Port_Question_DisMiss', 'TS_Port_Question_DisMiss_Callback' );
	...
	add_action( 'wp_ajax_nopriv_Total_Soft_GP_Prev', 'Total_Soft_GP_Prev_Callback' );
