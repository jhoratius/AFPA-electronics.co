...
<form method="POST" enctype="multipart/form-data">
	...
	<div class="Total_Soft_Portfolio_AMD">
		...
		<div class="Total_Soft_Portfolio_AMD2">
			...
			<span class="Total_Soft_Portfolio_AMD2_But" onclick="Total_Soft_Portfolio_AMD2_But1(<?php echo $TotalSoftPortfolioShortID[0]->Portfolio_ID+1;?>)">
				New Portfolio
			</span>
		</div>
	...
	<table class="Total_Soft_PortfolioAMOTable">
		<?php for($i=0;$i<count($TotalSoftPortfolio);$i++){
			...
			<tr id="Total_Soft_PortfolioAMOTable_tr_<?php echo $TotalSoftPortfolio[$i]->id;?>">
				...
				<td>
					<a href="<?php echo home_url(); ?>?ts_portfolio_preview=<?php echo $TotalSoftPortfolio[$i]->id;?>" class="Total_Soft_Portfolio_AMD2_But_LP" target="_blank">
						<i class="totalsoft totalsoft-eye"></i>
					</a>
				</td>
				<td><i class="totalsoft totalsoft-file-text" onclick="TotalSoftPortfolio_Clone(<?php echo $TotalSoftPortfolio[$i]->id;?>)"></i></td>
				<td><i class="totalsoft totalsoft-pencil" onclick="TotalSoftPortfolio_Edit(<?php echo $TotalSoftPortfolio[$i]->id;?>)"></i></td>
				<td>
					<i class="totalsoft totalsoft-trash" onclick="TotalSoftPortfolio_Del(<?php echo $TotalSoftPortfolio[$i]->id;?>)"></i>
